...
categories = {"0":"ignored", "1":"swimmer", "2":"swimmer with life jacket", "3":"boat", "6":"life jacket"}

if __name__ == '__main__':
    scriptTime = time.time()
    parser = argparse.ArgumentParser()
    parser.add_argument('--annotation', type=str, default='/home/agasthya/sea_drones_see_tracking/annotations/instances_test_objects_in_water.json', help='Path to the annotaion json file')
    parser.add_argument('--output', type=str, default='/home/agasthya/sea_drones_see_tracking/annotations_txt_format/instances_test_objects_in_water.txt', help='Path to the output txt file')
