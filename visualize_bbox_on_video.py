...
if __name__ == '__main__':
    ...
    parser.add_argument('--annotation', type=str, default='/home/agasthya/sea_drones_see_tracking/annotations/instances_val_objects_in_water.json', help='path to the annotations json file')
    parser.add_argument('--pictures', type=str, default='/home/agasthya/sea_drones_see_tracking/Compressed/val', help='path to the pictures')
    parser.add_argument('--output', type=str, default='/home/agasthya/sea_drones_see_tracking/output', help='Path to output')
